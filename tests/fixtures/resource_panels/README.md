...
```sh
python scripts/aoe4_assistant.py watch-resources --source-image tests/fixtures/resource_panels/resource_panel_idle_1.png
```

Run all fixtures:

```sh
python scripts/aoe4_assistant.py test-resources
```
