...
from backend.recognition.ageAndTimer import load_monitor
from backend.shared.common import grab_region_bgr, load_json, load_region, resolution_multiplier
from backend.shared.paths import source_path


VILLAGER_READER = "masked-template"
DEFAULT_VILLAGER_TEMPLATE = str(source_path("templates", "queue", "villager.png"))
