...
from backend.recognition.ageAndTimer import (
    command_capture_age,
    command_test_age,
    command_watch_age,
    load_monitor,
)
from backend.calibration.calibration import command_calibrate
from backend.runtime.overlay import (
    OVERLAY_AGES,
    OVERLAY_VILLAGER_STATES,
    command_write_overlay_state,
    parse_technology_keys,
)
from backend.runtime.monitor import add_monitor_args, command_watch_monitor
from backend.catalog.technology_catalog import (
    add_inject_technologies_args,
    command_inject_technologies,
)
from backend.shared.common import (
    REGIONS,
...
from backend.recognition.resources import command_test_resources, command_watch_resources
...
from backend.recognition.villager import (
...
def build_parser():
    ...
    test_resources.add_argument(
        "--fixture-dir",
        default="src/tests/fixtures/resource_panels",
    )
    ...
    test_villagers.add_argument(
        "--fixture-dir",
        default="src/tests/fixtures/villager_queue",
    )
