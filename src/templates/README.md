...
```sh
python src/backend/app/aoe4_assistant.py watch-villager --debug-images
python src/backend/app/aoe4_assistant.py match-research --debug-images --show-missing-templates
```
